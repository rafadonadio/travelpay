<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="Iventure.aspx.cs" Inherits="Iventure" Title="Solicitud"  %>
...
function getData(cardId)
{
	...
	var url = "GetData.aspx?IdIventure="+document.getElementById('<%= txtIdIventure.ClientID %>').value +"&CardId="+cardId;
	//var url = "PP.cs?IdIventure="+document.getElementById('<%= txtIdIventure.ClientID %>').value +"&CardId="+cardId;
...
function Buscar(tipo){
	...
	*/
	...
	<span style="font-size: 10pt; color: #ff0000" runat="server" id="lblTenga">* EL PRESENTE DOCUMENTO
		...
		por consecuencia tenga presente resguardar los datos ingresados. *<br />
	</span>
