...
/// <summary>
/// Summary description for CodigosNPS
/// </summary>
public class CodigosNPS
{
	...
	static CodigosNPS()
	{
		...
		tarjetas.Add("1", "American Express");
		tarjetas.Add("8", "Cabal");
		tarjetas.Add("2", "Diners");
		tarjetas.Add("5", "Mastercard");
		tarjetas.Add("9", "Naranja");
		tarjetas.Add("21", "Nevada");
		tarjetas.Add("14", "Visa");
